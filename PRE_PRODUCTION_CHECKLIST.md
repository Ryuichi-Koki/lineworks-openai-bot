...
- [x] `scripts/setup-line-rich-menu.mjs` を `--env=<ファイル名>` で
      対象環境を明示できる方式へ変更
- [x] 新リッチメニュー適用直前に `--status` で本番アカウントの
...
2. [x] Vercel Productionへコード `11f0686` をデプロイし、
   公開5ページのHTTP 200を確認（2026-07-29）
3. [x] LINEへ新リッチメニュー（2500x1686・6分割）を適用し、
   APIでデフォルト設定・6アクションを確認（2026-07-29）
