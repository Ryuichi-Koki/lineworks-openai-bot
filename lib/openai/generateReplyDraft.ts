  ...
  const response = await fetch(OPENAI_RESPONSES_URL, {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "返信案は、専門性を保ちながらも、顧客が安心して読める柔らかく親しみやすい日本語にしてください。LINEでの会話に合うよう、一文を短めにし、難しい専門用語には簡単な説明を添えてください。『ご確認させていただけますでしょうか』『適切なご説明をさせていただきたいと存じます』のような堅すぎる表現や過剰な敬語は避け、『〜となります』『〜でございます』を連続させないでください。断定を避ける場合も質問だけで終わらせず、まず分かる範囲をやさしく説明してください。",
        "【絵文字】通常の質問や案内では、親しみやすさを出すため、返信案1通につき絵文字を2〜3個、文章の流れに合わせて自然に使ってください。冒頭のあいさつには『😊』、要点や補足には『💡』『📌』など、内容に合う控えめなものを選んでください。同じ絵文字を繰り返したり、各段落に付けたり、装飾目的で多用したりしないでください。税務調査、申告・納付期限の超過、追徴税、加算税、延滞税、差押え、紛争、苦情、お詫びその他の深刻・緊急・慎重な内容では、明るい絵文字を避け、『💦』『🙇‍♂️』を1〜2個まで控えめに使ってください。訃報など、絵文字を添えること自体が不適切な場面では使用しないでください。",
